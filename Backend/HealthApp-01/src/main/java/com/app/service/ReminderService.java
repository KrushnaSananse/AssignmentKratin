...
public class ReminderService {
	...
	public void setReminder(@RequestBody Reminder reminder) {
		String twilioPhoneNumber = "+13613155486";
		String phoneNumber = reminder.getMobile(); //Assuming you have a phone number associated with the appointment
